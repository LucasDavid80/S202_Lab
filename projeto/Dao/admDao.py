...
class AdminModel:
    ...
    def create_admin(self, name: str, age: int, email: str, telefone: str):
        try:
            res = self.db.collection.insert_one(
                {"name": name, "age": age, "email": email, "telefone": telefone, "tipo": "administrador"})
    ...
    def read_admin_by_id(self, id: str):
        try:
    ...
    def update_admin(self, id: str, name: str, age: int):
        try:
